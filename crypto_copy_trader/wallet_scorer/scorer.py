...
from models.signals import WalletScore, classify_trust_level
...
class WalletScorer:
    ...
    def _list_evaluable_wallets(self) -> list[WalletScore]:
        connection = get_connection(self._addresses_repo._db_path)
        ...
        return [self._addresses_repo._row_to_wallet_score(row) for row in rows]
